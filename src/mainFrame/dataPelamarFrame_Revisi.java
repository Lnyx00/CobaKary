 ...
 * @author ilham
 */
public class dataPelamarFrame_Revisi extends javax.swing.JFrame {
...
//public cariBuku cb = null;
     ...
     */
    public dataPelamarFrame_Revisi() {
        initComponents();
        tanggal();
        datatable();
    }
...
//        nikTabel = tabmode.getValueAt(bar, 0).toString();
        ...
        String tglLahir = ((JTextField) tTGL.getDateEditor().getUiComponent()).getText();
        String tglTest = fix;
        ...
        try {
            String ubah = "UPDATE datapelamar set NIK='" + NIK + "',"
                    + "Nama='" + nama + "',"
                    + "Tempat='" + Tempat + "',"
                    + "tglLahir='" + tglLahir + "',"
                    + "JK='" + kelamin + "',"
                    ...
                    + "NoTelp='" + noHP + "',"
                    + "Alamat='" + Alamat + "',"
                    + "tglTest='" + tglTest + "' WHERE NIK='" + nikTabel + "'";
    ...
    public void ubahDataLaporan() {
        ...
        try {
            String ubah = "UPDATE lap_pen_karyawan set NIK='" + NIK + "',"
                    + "Nama='" + nama + "',"
...
System.out.println("INI TEST DELETE LAP " + nik);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "Data Karyawan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        comboLulusan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comboLulusanActionPerformed(evt);
            }
        });

        comboJabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--PILIH--", "Driver", "Security", "Staff Admin" }));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(tJadwalTest, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "Data Pelamar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/Print_16x16.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(1244, 709));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (tNIK.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Field Jadwal Test kosong!", "Error", JOptionPane.WARNING_MESSAGE);
        }
        else {
            simpanDataPelamar();
            simpanLap();
...
//        ((JTextField) tJadwalTest.getDateEditor().getUiComponent()).setText(tglTest);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        String nik = tNIK.getText();
        String Nama = tNama.getText();
        int tanya = JOptionPane.showConfirmDialog(null, "Hapus NIK: " + nik + "\nDengan Nama: " +Nama+"", "Konfrimasi Dialog", JOptionPane.YES_NO_CANCEL_OPTION);
            if (tanya == 0) {        
                delete();
                deleteLaporan();
                datatable();
    ...
    private void comboLulusanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboLulusanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_comboLulusanActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataPelamarFrame_Revisi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
