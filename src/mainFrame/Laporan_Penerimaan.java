 ...
 * @author ilham
 */
public class Laporan_Penerimaan extends javax.swing.JFrame {
    ...
    protected void datatable() {
        Object[] Baris = {"NIK", "Nama", "Jenis Kelamin", "Lulusan", "Jabatan", "Tgl Lamar", "No HP", "Tgl Test"};
...
//            String path = "./src/print/Pengembalian.jasper";
            InputStream path = getClass().getResourceAsStream("/print/lap_lamaran.jrxml");
...
//            parameter.put("kelas",jLabel32.getText());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2), "Laporan Penerimaan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIK", "Nama", "Jenis Kelamin", "Lulusan", "Jabatan", "Tanggal Lamar", "No Handphone", "Tanggal Test"
            }
        ));
...
//                    jumdata++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_Penerimaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_Penerimaan().setVisible(true);
            }
        });
    }
